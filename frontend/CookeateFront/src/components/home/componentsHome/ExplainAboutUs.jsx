function ExplainAboutUs() {
  return (
    <section>
      <article className="article_wrapper" style={{marginTop:-38}}>
      ...
      <article className="p_wrapper">
        ...
        <p className="paragraph_style">
          ...
          opciones culinarias para todos los gustos y ocasiones. 
        </p>
        ...
        <p className="paragraph_style">
          ...
          crear comidas que satisfacen todos los paladares. 
        </p>
